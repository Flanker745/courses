                    ...
                    <tbody>
                        <x-table.row class="grid-cols-8">
                            ...
                            <x-table.td class="col-span-2 overflow-y-scroll text-xs">
                                <p class="h-full">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Labore
                                    cumque,
                                    perferendis expedita, perspiciatis maxime nam voluptas quisquam sunt esse explicabo
                                    asperiores!
